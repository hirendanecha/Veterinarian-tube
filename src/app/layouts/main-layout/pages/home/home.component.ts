...
export class HomeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  editCommunity(data): void {
    ...
    modalRef.componentInstance.title = `Edit ${
      data.pageType === 'community' ? 'veterinarian' : 'Page'
    } Details`;
  ...
  removeFromCommunity(id?): void {
    ...
    modalRef.componentInstance.title = `Leave ${this.communityDetails.pageType === "community" ? "Veterinarian" : "page"}`;
    modalRef.componentInstance.confirmButtonLabel = id ? 'Remove' : 'Leave';
    modalRef.componentInstance.cancelButtonLabel = 'Cancel';
    if (id) {
      modalRef.componentInstance.message = `Are you sure want to remove this member from ${this.communityDetails.pageType === "community" ? "Veterinarian" : "page"}?`;
    } else {
      modalRef.componentInstance.message = `Are you sure want to Leave from this ${this.communityDetails.pageType === "community" ? "Veterinarian" : "page"}?`;
    }
    modalRef.result.then((res) => {
      if (res === 'success') {
